  ...
  var __webpack_modules__ = {
    ...
    function srcJsBurgerJs(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function _burger() {
        ...
        showHeaderBtn = document.querySelector('.header__buttons'); // iconBurger = document.querySelector('.icon__hamburger');
